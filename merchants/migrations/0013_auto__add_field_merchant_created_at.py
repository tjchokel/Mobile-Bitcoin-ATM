...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchant.created_at'
        db.add_column(u'merchants_merchant', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 23, 0, 0), db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchant.created_at'
        db.delete_column(u'merchants_merchant', 'created_at')
