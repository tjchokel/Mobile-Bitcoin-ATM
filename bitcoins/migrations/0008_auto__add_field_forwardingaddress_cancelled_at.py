...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForwardingAddress.cancelled_at'
        db.add_column(u'bitcoins_forwardingaddress', 'cancelled_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForwardingAddress.cancelled_at'
        db.delete_column(u'bitcoins_forwardingaddress', 'cancelled_at')
