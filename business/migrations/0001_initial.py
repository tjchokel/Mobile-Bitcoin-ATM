...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'business_appuser', (
        ...
        db.send_create_signal(u'business', ['AppUser'])

        # Adding M2M table for field groups on 'AppUser'
        m2m_table_name = db.shorten_name(u'business_appuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('appuser', models.ForeignKey(orm[u'business.appuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['appuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'AppUser'
        m2m_table_name = db.shorten_name(u'business_appuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('appuser', models.ForeignKey(orm[u'business.appuser'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'business_appuser')

        # Removing M2M table for field groups on 'AppUser'
        db.delete_table(db.shorten_name(u'business_appuser_groups'))

        # Removing M2M table for field user_permissions on 'AppUser'
        db.delete_table(db.shorten_name(u'business_appuser_user_permissions'))
