...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SentEmail.sent_via'
        db.add_column(u'emails_sentemail', 'sent_via',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SentEmail.sent_via'
        db.delete_column(u'emails_sentemail', 'sent_via')
    ...
    models = {
        ...
        u'emails.sentemail': {
            ...
            'sent_via': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '3', 'null': 'True', 'blank': 'True'}),
