...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppUser.phone_num_country'
        db.add_column(u'business_appuser', 'phone_num_country',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppUser.phone_num_country'
        db.delete_column(u'business_appuser', 'phone_num_country')
