...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BTCTransaction.met_minimum_confirmation_at'
        db.add_column(u'bitcoins_btctransaction', 'met_minimum_confirmation_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BTCTransaction.met_minimum_confirmation_at'
        db.delete_column(u'bitcoins_btctransaction', 'met_minimum_confirmation_at')
    ...
    models = {
        ...
        u'bitcoins.btctransaction': {
            ...
            'conf_num': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
