...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpenTime.is_closed_this_day'
        db.add_column(u'merchants_opentime', 'is_closed_this_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpenTime.is_closed_this_day'
        db.delete_column(u'merchants_opentime', 'is_closed_this_day')
