...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'APICall.url_hit'
        db.alter_column(u'services_apicall', 'url_hit', self.gf('django.db.models.fields.URLField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'APICall.url_hit'
        db.alter_column(u'services_apicall', 'url_hit', self.gf('django.db.models.fields.URLField')(max_length=200))
