...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailAuthToken.key_deleted_at'
        db.add_column(u'users_emailauthtoken', 'key_deleted_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 20, 0, 0), db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailAuthToken.key_deleted_at'
        db.delete_column(u'users_emailauthtoken', 'key_deleted_at')
    ...
    models = {
        ...
        u'users.emailauthtoken': {
            ...
            'key_deleted_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 20, 0, 0)', 'db_index': 'True'}),
            ...
            'verif_key': ('django.db.models.fields.CharField', [], {'default': "'6f5mHUBn5N4wDqRdTzhxMDtZzNedX5gr'", 'max_length': '64', 'db_index': 'True'})
        },
