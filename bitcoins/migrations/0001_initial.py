...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BTCTransaction'
        db.create_table(u'bitcoins_btctransaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table(u'bitcoins_shopperbtcpurchase', (
            ...
            ('credential_link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credentials.CredentialLink'], null=True, blank=True)),
    ...
    models = {
        ...
        u'bitcoins.shopperbtcpurchase': {
            ...
            'credential_link': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['credentials.CredentialLink']", 'null': 'True', 'blank': 'True'}),
