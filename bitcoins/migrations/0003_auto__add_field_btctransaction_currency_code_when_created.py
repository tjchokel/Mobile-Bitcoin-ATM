...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BTCTransaction.currency_code_when_created'
        db.add_column(u'bitcoins_btctransaction', 'currency_code_when_created',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BTCTransaction.currency_code_when_created'
        db.delete_column(u'bitcoins_btctransaction', 'currency_code_when_created')
