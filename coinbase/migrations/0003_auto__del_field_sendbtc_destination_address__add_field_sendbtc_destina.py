...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SendBTC.destination_address'
        db.delete_column(u'coinbase_sendbtc', 'destination_address')

        # Adding field 'SendBTC.destination_btc_address'
        db.add_column(u'coinbase_sendbtc', 'destination_btc_address',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=34, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SendBTC.destionation_email'
        db.add_column(u'coinbase_sendbtc', 'destionation_email',
                      self.gf('django.db.models.fields.EmailField')(db_index=True, max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SendBTC.destination_address'
        raise RuntimeError("Cannot reverse this migration. 'SendBTC.destination_address' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SendBTC.destination_address'
        db.add_column(u'coinbase_sendbtc', 'destination_address',
                      self.gf('django.db.models.fields.CharField')(max_length=34, db_index=True),
                      keep_default=False)

        # Deleting field 'SendBTC.destination_btc_address'
        db.delete_column(u'coinbase_sendbtc', 'destination_btc_address')

        # Deleting field 'SendBTC.destionation_email'
        db.delete_column(u'coinbase_sendbtc', 'destionation_email')
    ...
    models = {
        ...
        u'coinbase.sendbtc': {
            ...
            'destionation_email': ('django.db.models.fields.EmailField', [], {'db_index': 'True', 'max_length': '75', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
