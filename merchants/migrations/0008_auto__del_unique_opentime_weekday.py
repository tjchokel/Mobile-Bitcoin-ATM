...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'OpenTime', fields ['weekday']
        db.delete_unique(u'merchants_opentime', ['weekday'])


    def backwards(self, orm):
        # Adding unique constraint on 'OpenTime', fields ['weekday']
        db.create_unique(u'merchants_opentime', ['weekday'])
