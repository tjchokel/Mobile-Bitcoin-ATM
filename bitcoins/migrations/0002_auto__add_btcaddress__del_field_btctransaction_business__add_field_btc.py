...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bitcoins_btcaddress', (
            ...
            ('revealed_to_user_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('retired_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('last_checked_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bitcoins_btctransaction', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['business.Business'], null=True, blank=True),
                      keep_default=False)
