...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BTCTransaction.min_confirmations_overrode_at'
        db.add_column(u'bitcoins_btctransaction', 'min_confirmations_overrode_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BTCTransaction.min_confirmations_overrode_at'
        db.delete_column(u'bitcoins_btctransaction', 'min_confirmations_overrode_at')
