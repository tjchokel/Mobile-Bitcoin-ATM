...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'BTCAddress'
        db.delete_table(u'bitcoins_btcaddress')

        # Adding model 'ForwardingAddress'
        db.create_table(u'bitcoins_forwardingaddress', (
        ...
        db.send_create_signal(u'bitcoins', ['DestinationAddress'])


        # Changing field 'BTCTransaction.btc_address'
        db.alter_column(u'bitcoins_btctransaction', 'btc_address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.ForwardingAddress'], null=True))

    def backwards(self, orm):
        # Adding model 'BTCAddress'
        db.create_table(u'bitcoins_btcaddress', (
            ('revealed_to_user_at', self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, db_index=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['business.Business'], null=True, blank=True)),
            ('b58_address', self.gf('django.db.models.fields.CharField')(max_length=34, unique=True, db_index=True)),
            ('generated_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('retired_at', self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, db_index=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_checked_at', self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, db_index=True)),
        ))
        db.send_create_signal(u'bitcoins', ['BTCAddress'])

        # Deleting model 'ForwardingAddress'
        db.delete_table(u'bitcoins_forwardingaddress')

        # Deleting model 'DestinationAddress'
        db.delete_table(u'bitcoins_destinationaddress')


        # Changing field 'BTCTransaction.btc_address'
        db.alter_column(u'bitcoins_btctransaction', 'btc_address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.BTCAddress'], null=True))
