...
# Copied 2014-03-19 from https://bitcointalk.org/index.php?topic=1026.msg12557#msg12557
#
import re
...
def is_valid_btc_address(address):
    '''
    Utility function based on above for address validation (outside of a form)
    '''
    address = address.strip()
    if re.match(r"[a-zA-Z1-9]{27,35}$", address) is None:
        return False
    if get_bcaddress_version(address) is None:
        return False
    return True
