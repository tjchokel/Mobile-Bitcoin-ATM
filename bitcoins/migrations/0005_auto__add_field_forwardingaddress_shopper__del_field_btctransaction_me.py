...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForwardingAddress.shopper'
        db.add_column(u'bitcoins_forwardingaddress', 'shopper',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shoppers.Shopper'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BTCTransaction.merchant'
        db.delete_column(u'bitcoins_btctransaction', 'merchant_id')

        # Deleting field 'BTCTransaction.shopper'
        db.delete_column(u'bitcoins_btctransaction', 'shopper_id')


    def backwards(self, orm):
        # Deleting field 'ForwardingAddress.shopper'
        db.delete_column(u'bitcoins_forwardingaddress', 'shopper_id')

        # Adding field 'BTCTransaction.merchant'
        db.add_column(u'bitcoins_btctransaction', 'merchant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['merchants.Merchant']),
                      keep_default=False)

        # Adding field 'BTCTransaction.shopper'
        db.add_column(u'bitcoins_btctransaction', 'shopper',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shoppers.Shopper'], null=True, blank=True),
                      keep_default=False)
