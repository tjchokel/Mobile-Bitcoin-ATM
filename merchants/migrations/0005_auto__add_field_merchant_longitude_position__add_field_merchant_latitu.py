...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchant.longitude_position'
        db.add_column(u'merchants_merchant', 'longitude_position',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Merchant.latitude_position'
        db.add_column(u'merchants_merchant', 'latitude_position',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchant.longitude_position'
        db.delete_column(u'merchants_merchant', 'longitude_position')

        # Deleting field 'Merchant.latitude_position'
        db.delete_column(u'merchants_merchant', 'latitude_position')
