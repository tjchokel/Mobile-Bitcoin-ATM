...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BitcoinPurchase'
        db.create_table(u'bitcoins_bitcoinpurchase', (
        ...
        db.send_create_signal(u'bitcoins', ['BitcoinPurchase'])


    def backwards(self, orm):
        # Deleting model 'BitcoinPurchase'
        db.delete_table(u'bitcoins_bitcoinpurchase')
