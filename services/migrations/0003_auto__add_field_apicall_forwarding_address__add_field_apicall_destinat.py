...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APICall.forwarding_address'
        db.add_column(u'services_apicall', 'forwarding_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.ForwardingAddress'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'APICall.destination_address'
        db.add_column(u'services_apicall', 'destination_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.DestinationAddress'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APICall.forwarding_address'
        db.delete_column(u'services_apicall', 'forwarding_address_id')

        # Deleting field 'APICall.destination_address'
        db.delete_column(u'services_apicall', 'destination_address_id')
    ...
    models = {
        ...
        u'services.apicall': {
            ...
            'url_hit': ('django.db.models.fields.URLField', [], {'max_length': '1024', 'db_index': 'True'})
        },
        u'services.webhook': {
