...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Merchant.buy_btc_markup'
        db.delete_column(u'merchants_merchant', 'buy_btc_markup')

        # Deleting field 'Merchant.sell_btc_markup'
        db.delete_column(u'merchants_merchant', 'sell_btc_markup')

        # Adding field 'Merchant.cashin_markup_in_bps'
        db.add_column(u'merchants_merchant', 'cashin_markup_in_bps',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Merchant.cashout_markup_in_bps'
        db.add_column(u'merchants_merchant', 'cashout_markup_in_bps',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Merchant.buy_btc_markup'
        db.add_column(u'merchants_merchant', 'buy_btc_markup',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Merchant.sell_btc_markup'
        db.add_column(u'merchants_merchant', 'sell_btc_markup',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'Merchant.cashin_markup_in_bps'
        db.delete_column(u'merchants_merchant', 'cashin_markup_in_bps')

        # Deleting field 'Merchant.cashout_markup_in_bps'
        db.delete_column(u'merchants_merchant', 'cashout_markup_in_bps')
