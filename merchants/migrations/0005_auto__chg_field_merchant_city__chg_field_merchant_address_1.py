...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Merchant.city'
        db.alter_column(u'merchants_merchant', 'city', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Merchant.address_1'
        db.alter_column(u'merchants_merchant', 'address_1', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Merchant.city'
        raise RuntimeError("Cannot reverse this migration. 'Merchant.city' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Merchant.city'
        db.alter_column(u'merchants_merchant', 'city', self.gf('django.db.models.fields.CharField')(max_length=256))

        # User chose to not deal with backwards NULL issues for 'Merchant.address_1'
        raise RuntimeError("Cannot reverse this migration. 'Merchant.address_1' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Merchant.address_1'
        db.alter_column(u'merchants_merchant', 'address_1', self.gf('django.db.models.fields.CharField')(max_length=256))
