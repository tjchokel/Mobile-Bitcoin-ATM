...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BSCredential'
        db.create_table(u'bstamp_bscredential', (
        ...
        db.send_create_signal(u'bstamp', ['BSCredential'])

        # Adding model 'BSBalance'
        db.create_table(u'bstamp_bsbalance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('bs_credential', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bstamp.BSCredential'])),
            ('satoshis', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'bstamp', ['BSBalance'])

        # Adding model 'BSSendBTC'
        db.create_table(u'bstamp_bssendbtc', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('bs_credential', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bstamp.BSCredential'])),
            ('bs_withdrawal_id', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
            ('satoshis', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
        ...
        db.send_create_signal(u'bstamp', ['BSSendBTC'])


    def backwards(self, orm):
        # Deleting model 'BSCredential'
        db.delete_table(u'bstamp_bscredential')

        # Deleting model 'BSBalance'
        db.delete_table(u'bstamp_bsbalance')

        # Deleting model 'BSSendBTC'
        db.delete_table(u'bstamp_bssendbtc')
    ...
    models = {
        ...
        u'bstamp.bsbalance': {
            'Meta': {'object_name': 'BSBalance'},
            'bs_credential': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bstamp.BSCredential']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'satoshis': ('django.db.models.fields.BigIntegerField', [], {'db_index': 'True'})
        },
        u'bstamp.bscredential': {
            'Meta': {'object_name': 'BSCredential'},
        ...
        u'bstamp.bssendbtc': {
            'Meta': {'object_name': 'BSSendBTC'},
            'bs_credential': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bstamp.BSCredential']"}),
            'bs_withdrawal_id': ('django.db.models.fields.BigIntegerField', [], {'db_index': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
