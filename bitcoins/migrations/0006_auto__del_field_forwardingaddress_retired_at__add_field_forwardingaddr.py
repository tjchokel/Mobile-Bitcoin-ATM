...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ForwardingAddress.retired_at'
        db.delete_column(u'bitcoins_forwardingaddress', 'retired_at')

        # Adding field 'ForwardingAddress.paid_out_at'
        db.add_column(u'bitcoins_forwardingaddress', 'paid_out_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ForwardingAddress.retired_at'
        db.add_column(u'bitcoins_forwardingaddress', 'retired_at',
                      self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'ForwardingAddress.paid_out_at'
        db.delete_column(u'bitcoins_forwardingaddress', 'paid_out_at')
