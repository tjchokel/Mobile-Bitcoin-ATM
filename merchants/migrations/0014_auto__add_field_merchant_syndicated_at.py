...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchant.syndicated_at'
        db.add_column(u'merchants_merchant', 'syndicated_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchant.syndicated_at'
        db.delete_column(u'merchants_merchant', 'syndicated_at')
    ...
    models = {
        ...
        u'merchants.merchant': {
            ...
            'syndicated_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
