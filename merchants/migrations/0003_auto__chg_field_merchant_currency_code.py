...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Merchant.currency_code'
        db.alter_column(u'merchants_merchant', 'currency_code', self.gf('django.db.models.fields.CharField')(default=0, max_length=5))

    def backwards(self, orm):

        # Changing field 'Merchant.currency_code'
        db.alter_column(u'merchants_merchant', 'currency_code', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
