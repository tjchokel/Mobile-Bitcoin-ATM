...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShopperBTCPurchase.payment_via'
        db.add_column(u'bitcoins_shopperbtcpurchase', 'payment_via',
                      self.gf('django.db.models.fields.CharField')(default='CBS', max_length=3, db_index=True),
                      keep_default=False)

        # Adding field 'ShopperBTCPurchase.btc_transaction'
        db.add_column(u'bitcoins_shopperbtcpurchase', 'btc_transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.BTCTransaction'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopperBTCPurchase.merchant_email_sent_at'
        db.add_column(u'bitcoins_shopperbtcpurchase', 'merchant_email_sent_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopperBTCPurchase.shopper_email_sent_at'
        db.add_column(u'bitcoins_shopperbtcpurchase', 'shopper_email_sent_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShopperBTCPurchase.payment_via'
        db.delete_column(u'bitcoins_shopperbtcpurchase', 'payment_via')

        # Deleting field 'ShopperBTCPurchase.btc_transaction'
        db.delete_column(u'bitcoins_shopperbtcpurchase', 'btc_transaction_id')

        # Deleting field 'ShopperBTCPurchase.merchant_email_sent_at'
        db.delete_column(u'bitcoins_shopperbtcpurchase', 'merchant_email_sent_at')

        # Deleting field 'ShopperBTCPurchase.shopper_email_sent_at'
        db.delete_column(u'bitcoins_shopperbtcpurchase', 'shopper_email_sent_at')
    ...
    models = {
        ...
        u'bitcoins.shopperbtcpurchase': {
            ...
            'payment_via': ('django.db.models.fields.CharField', [], {'max_length': '3', 'db_index': 'True'}),
            'satoshis': ('django.db.models.fields.BigIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
