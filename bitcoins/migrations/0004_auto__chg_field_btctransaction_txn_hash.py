...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BTCTransaction.txn_hash'
        db.alter_column(u'bitcoins_btctransaction', 'txn_hash', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=64))

    def backwards(self, orm):

        # Changing field 'BTCTransaction.txn_hash'
        db.alter_column(u'bitcoins_btctransaction', 'txn_hash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64, null=True))
