...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForwardingAddress.business'
        db.add_column(u'bitcoins_forwardingaddress', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['business.Business']),
                      keep_default=False)

        # Deleting field 'BTCTransaction.btc_address'
        db.delete_column(u'bitcoins_btctransaction', 'btc_address_id')

        # Adding field 'BTCTransaction.forwarding_address'
        db.add_column(u'bitcoins_btctransaction', 'forwarding_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.ForwardingAddress'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BTCTransaction.destination_address'
        db.add_column(u'bitcoins_btctransaction', 'destination_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.DestinationAddress'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BTCTransaction.business'
        db.add_column(u'bitcoins_btctransaction', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['business.Business']),
                      keep_default=False)


        # Changing field 'DestinationAddress.business'
        db.alter_column(u'bitcoins_destinationaddress', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['business.Business']))

    def backwards(self, orm):
        # Deleting field 'ForwardingAddress.business'
        db.delete_column(u'bitcoins_forwardingaddress', 'business_id')

        # Adding field 'BTCTransaction.btc_address'
        db.add_column(u'bitcoins_btctransaction', 'btc_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.ForwardingAddress'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BTCTransaction.forwarding_address'
        db.delete_column(u'bitcoins_btctransaction', 'forwarding_address_id')

        # Deleting field 'BTCTransaction.destination_address'
        db.delete_column(u'bitcoins_btctransaction', 'destination_address_id')

        # Deleting field 'BTCTransaction.business'
        db.delete_column(u'bitcoins_btctransaction', 'business_id')


        # Changing field 'DestinationAddress.business'
        db.alter_column(u'bitcoins_destinationaddress', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['business.Business'], null=True))
