...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BTCTransaction.fiat_ammount'
        db.alter_column(u'bitcoins_btctransaction', 'fiat_ammount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'BTCTransaction.fiat_ammount'
        db.alter_column(u'bitcoins_btctransaction', 'fiat_ammount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
