...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShopperBTCPurchase.base_sent_btc'
        db.add_column(u'bitcoins_shopperbtcpurchase', 'base_sent_btc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credentials.BaseSentBTC'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShopperBTCPurchase.base_sent_btc'
        db.delete_column(u'bitcoins_shopperbtcpurchase', 'base_sent_btc_id')
