...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OpenTime.to_time'
        db.alter_column(u'merchants_opentime', 'to_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'OpenTime.from_time'
        db.alter_column(u'merchants_opentime', 'from_time', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OpenTime.to_time'
        raise RuntimeError("Cannot reverse this migration. 'OpenTime.to_time' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'OpenTime.to_time'
        db.alter_column(u'merchants_opentime', 'to_time', self.gf('django.db.models.fields.TimeField')())

        # User chose to not deal with backwards NULL issues for 'OpenTime.from_time'
        raise RuntimeError("Cannot reverse this migration. 'OpenTime.from_time' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'OpenTime.from_time'
        db.alter_column(u'merchants_opentime', 'from_time', self.gf('django.db.models.fields.TimeField')())
    ...
    models = {
        ...
        u'merchants.merchant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude_position': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '3', 'blank': 'True'}),
            'longitude_position': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '3', 'blank': 'True'}),
