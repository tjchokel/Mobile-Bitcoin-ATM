...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForwardingAddress.last_activity_check_at'
        db.add_column(u'bitcoins_forwardingaddress', 'last_activity_check_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BTCTransaction.input_btc_transaction'
        db.delete_column(u'bitcoins_btctransaction', 'input_btc_transaction_id')


    def backwards(self, orm):
        # Deleting field 'ForwardingAddress.last_activity_check_at'
        db.delete_column(u'bitcoins_forwardingaddress', 'last_activity_check_at')

        # Adding field 'BTCTransaction.input_btc_transaction'
        db.add_column(u'bitcoins_btctransaction', 'input_btc_transaction',
