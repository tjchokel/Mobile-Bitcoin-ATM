...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.basis_points_markup'
        db.add_column(u'business_business', 'basis_points_markup',
                      self.gf('django.db.models.fields.IntegerField')(default=100, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Business.btc_storage_address'
        db.add_column(u'business_business', 'btc_storage_address',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=34, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.basis_points_markup'
        db.delete_column(u'business_business', 'basis_points_markup')

        # Deleting field 'Business.btc_storage_address'
        db.delete_column(u'business_business', 'btc_storage_address')
    ...
    models = {
        ...
        u'business.business': {
            ...
            'btc_storage_address': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '34', 'null': 'True', 'blank': 'True'}),
