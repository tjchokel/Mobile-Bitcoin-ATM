...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BTCTransaction.fiat_ammount'
        db.delete_column(u'bitcoins_btctransaction', 'fiat_ammount')
        ...
        # Adding field 'BTCTransaction.fiat_amount'
        db.add_column(u'bitcoins_btctransaction', 'fiat_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BTCTransaction.fiat_ammount'
        db.add_column(u'bitcoins_btctransaction', 'fiat_ammount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'BTCTransaction.fiat_amount'
        db.delete_column(u'bitcoins_btctransaction', 'fiat_amount')
