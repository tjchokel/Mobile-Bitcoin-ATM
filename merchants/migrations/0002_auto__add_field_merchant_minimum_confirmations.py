...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchant.minimum_confirmations'
        db.add_column(u'merchants_merchant', 'minimum_confirmations',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchant.minimum_confirmations'
        db.delete_column(u'merchants_merchant', 'minimum_confirmations')
