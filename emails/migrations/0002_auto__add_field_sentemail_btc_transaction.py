...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SentEmail.btc_transaction'
        db.add_column(u'emails_sentemail', 'btc_transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.BTCTransaction'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SentEmail.btc_transaction'
        db.delete_column(u'emails_sentemail', 'btc_transaction_id')
