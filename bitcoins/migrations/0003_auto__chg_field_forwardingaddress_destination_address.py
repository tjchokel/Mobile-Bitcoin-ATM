...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ForwardingAddress.destination_address'
        db.alter_column(u'bitcoins_forwardingaddress', 'destination_address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bitcoins.DestinationAddress']))

    def backwards(self, orm):

        # Changing field 'ForwardingAddress.destination_address'
        db.alter_column(u'bitcoins_forwardingaddress', 'destination_address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.DestinationAddress'], null=True))
