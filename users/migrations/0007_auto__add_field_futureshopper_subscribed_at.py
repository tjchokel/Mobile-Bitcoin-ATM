...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FutureShopper.subscribed_at'
        db.add_column(u'users_futureshopper', 'subscribed_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 19, 0, 0), db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FutureShopper.subscribed_at'
        db.delete_column(u'users_futureshopper', 'subscribed_at')
    ...
    models = {
        ...
        u'users.emailauthtoken': {
            ...
            'key_deleted_at': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'key_expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 20, 0, 0)', 'db_index': 'True'}),
            ...
            'verif_key': ('django.db.models.fields.CharField', [], {'default': "'eBwwXQ8bgQUrKEsC4cBv2Ug3A2CkDCD7'", 'max_length': '64', 'db_index': 'True'})
        },
        u'users.futureshopper': {
            ...
            'subscribed_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        u'users.loggedlogin': {
