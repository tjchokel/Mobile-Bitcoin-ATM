...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShopperBTCPurchase.credential'
        db.add_column(u'bitcoins_shopperbtcpurchase', 'credential',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credentials.Credential'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bitcoins_shopperbtcpurchase', 'payment_via',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, db_index=True),
                      keep_default=False)

        # Deleting field 'ShopperBTCPurchase.credential'
        db.delete_column(u'bitcoins_shopperbtcpurchase', 'credential_id')
    ...
    models = {
        ...
        u'bitcoins.shopperbtcpurchase': {
            ...
            'credential': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['credentials.Credential']", 'null': 'True', 'blank': 'True'}),
