...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Merchant.hours'
        db.alter_column(u'merchants_merchant', 'hours', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Merchant.hours'
        raise RuntimeError("Cannot reverse this migration. 'Merchant.hours' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Merchant.hours'
        db.alter_column(u'merchants_merchant', 'hours', self.gf('django.db.models.fields.CharField')(max_length=256))
