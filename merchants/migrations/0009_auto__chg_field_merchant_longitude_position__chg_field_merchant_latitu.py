...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Merchant.longitude_position'
        db.alter_column(u'merchants_merchant', 'longitude_position', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # Changing field 'Merchant.latitude_position'
        db.alter_column(u'merchants_merchant', 'latitude_position', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))
    ...
    models = {
        ...
        u'merchants.merchant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude_position': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '8', 'blank': 'True'}),
            'longitude_position': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '8', 'blank': 'True'}),
