...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.currency_code'
        db.add_column(u'business_business', 'currency_code',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.currency_code'
        db.delete_column(u'business_business', 'currency_code')
