...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Merchant', fields ['longitude_position']
        db.create_index(u'merchants_merchant', ['longitude_position'])

        # Adding index on 'Merchant', fields ['latitude_position']
        db.create_index(u'merchants_merchant', ['latitude_position'])


    def backwards(self, orm):
        # Removing index on 'Merchant', fields ['latitude_position']
        db.delete_index(u'merchants_merchant', ['latitude_position'])

        # Removing index on 'Merchant', fields ['longitude_position']
        db.delete_index(u'merchants_merchant', ['longitude_position'])
