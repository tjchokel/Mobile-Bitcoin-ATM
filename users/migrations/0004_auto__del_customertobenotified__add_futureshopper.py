...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CustomerToBeNotified'
        db.delete_table(u'users_customertobenotified')

        # Adding model 'FutureShopper'
        db.create_table(u'users_futureshopper', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, db_index=True)),
            ('city', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=256, null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=256, db_index=True)),
            ('intention', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=256, null=True, blank=True)),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['FutureShopper'])


    def backwards(self, orm):
        # Adding model 'CustomerToBeNotified'
        db.create_table(u'users_customertobenotified', (
            ('city', self.gf('django.db.models.fields.CharField')(blank=True, max_length=256, null=True, db_index=True)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=256, db_index=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, db_index=True)),
            ('intention', self.gf('django.db.models.fields.CharField')(blank=True, max_length=256, null=True, db_index=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'users', ['CustomerToBeNotified'])

        # Deleting model 'FutureShopper'
        db.delete_table(u'users_futureshopper')
