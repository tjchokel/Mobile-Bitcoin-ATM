...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CBCredential.api_secret'
        db.alter_column(u'coinbase_cbcredential', 'api_secret', self.gf('django_fields.fields.EncryptedCharField')(default=None, max_length=293, block_type=None, cipher='AES'))

        # Changing field 'CBCredential.api_key'
        db.alter_column(u'coinbase_cbcredential', 'api_key', self.gf('django_fields.fields.EncryptedCharField')(default=None, max_length=165, block_type=None, cipher='AES'))

    def backwards(self, orm):

        # Changing field 'CBCredential.api_secret'
        db.alter_column(u'coinbase_cbcredential', 'api_secret', self.gf('django_fields.fields.EncryptedCharField')(block_type=None, max_length=293, null=True, cipher='AES'))

        # Changing field 'CBCredential.api_key'
        db.alter_column(u'coinbase_cbcredential', 'api_key', self.gf('django_fields.fields.EncryptedCharField')(block_type=None, max_length=165, null=True, cipher='AES'))
