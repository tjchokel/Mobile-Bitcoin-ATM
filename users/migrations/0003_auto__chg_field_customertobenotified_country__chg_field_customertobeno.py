...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerToBeNotified.country'
        db.alter_column(u'users_customertobenotified', 'country', self.gf('django.db.models.fields.CharField')(default='DEFAULT', max_length=256))

        # Changing field 'CustomerToBeNotified.email'
        db.alter_column(u'users_customertobenotified', 'email', self.gf('django.db.models.fields.EmailField')(default='DEFAULT', max_length=75))

    def backwards(self, orm):

        # Changing field 'CustomerToBeNotified.country'
        db.alter_column(u'users_customertobenotified', 'country', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'CustomerToBeNotified.email'
        db.alter_column(u'users_customertobenotified', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    models = {
        ...
        u'users.customertobenotified': {
            'Meta': {'object_name': 'CustomerToBeNotified'},
