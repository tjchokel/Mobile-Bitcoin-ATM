...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'APICall.user'
        db.delete_column(u'services_apicall', 'user_id')

        # Adding field 'APICall.merchant'
        db.add_column(u'services_apicall', 'merchant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['merchants.Merchant'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'APICall.user'
        db.add_column(u'services_apicall', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['merchants.AppUser'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'APICall.merchant'
        db.delete_column(u'services_apicall', 'merchant_id')
