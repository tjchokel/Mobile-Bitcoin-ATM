...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SentSMS.message_type'
        db.add_column(u'phones_sentsms', 'message_type',
                      self.gf('django.db.models.fields.CharField')(default='NA', max_length=3, db_index=True),
                      keep_default=False)

        # Adding field 'SentSMS.btc_transaction'
        db.add_column(u'phones_sentsms', 'btc_transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bitcoins.BTCTransaction'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SentSMS.message_type'
        db.delete_column(u'phones_sentsms', 'message_type')

        # Deleting field 'SentSMS.btc_transaction'
        db.delete_column(u'phones_sentsms', 'btc_transaction_id')
    ...
    models = {
        ...
        u'phones.sentsms': {
            ...
            'message_type': ('django.db.models.fields.CharField', [], {'max_length': '3', 'db_index': 'True'}),
