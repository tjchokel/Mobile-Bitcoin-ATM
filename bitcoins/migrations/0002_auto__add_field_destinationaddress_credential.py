...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DestinationAddress.credential'
        db.add_column(u'bitcoins_destinationaddress', 'credential',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['credentials.BaseCredential'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DestinationAddress.credential'
        db.delete_column(u'bitcoins_destinationaddress', 'credential_id')
