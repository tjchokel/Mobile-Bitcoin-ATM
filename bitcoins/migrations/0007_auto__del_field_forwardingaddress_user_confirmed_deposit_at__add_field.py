...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ForwardingAddress.user_confirmed_deposit_at'
        db.delete_column(u'bitcoins_forwardingaddress', 'user_confirmed_deposit_at')

        # Adding field 'ForwardingAddress.customer_confirmed_deposit_at'
        db.add_column(u'bitcoins_forwardingaddress', 'customer_confirmed_deposit_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ForwardingAddress.user_confirmed_deposit_at'
        db.add_column(u'bitcoins_forwardingaddress', 'user_confirmed_deposit_at',
                      self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'ForwardingAddress.customer_confirmed_deposit_at'
        db.delete_column(u'bitcoins_forwardingaddress', 'customer_confirmed_deposit_at')
