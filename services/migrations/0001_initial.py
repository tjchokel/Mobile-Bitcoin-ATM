...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'services_apicall', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['business.AppUser'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'services.apicall': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['business.AppUser']", 'null': 'True', 'blank': 'True'})
        }
    }
