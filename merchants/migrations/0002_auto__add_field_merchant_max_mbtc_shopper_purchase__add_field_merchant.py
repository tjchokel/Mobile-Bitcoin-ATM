...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchant.max_mbtc_shopper_purchase'
        db.add_column(u'merchants_merchant', 'max_mbtc_shopper_purchase',
                      self.gf('django.db.models.fields.IntegerField')(default=1000, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Merchant.max_mbtc_shopper_sale'
        db.add_column(u'merchants_merchant', 'max_mbtc_shopper_sale',
                      self.gf('django.db.models.fields.IntegerField')(default=1000, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchant.max_mbtc_shopper_purchase'
        db.delete_column(u'merchants_merchant', 'max_mbtc_shopper_purchase')

        # Deleting field 'Merchant.max_mbtc_shopper_sale'
        db.delete_column(u'merchants_merchant', 'max_mbtc_shopper_sale')
