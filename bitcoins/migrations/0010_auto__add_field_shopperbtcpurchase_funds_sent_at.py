...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShopperBTCPurchase.funds_sent_at'
        db.add_column(u'bitcoins_shopperbtcpurchase', 'funds_sent_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShopperBTCPurchase.funds_sent_at'
        db.delete_column(u'bitcoins_shopperbtcpurchase', 'funds_sent_at')
