...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APICredential'
        db.create_table(u'coinbase_apicredential', (
        ...
        db.send_create_signal(u'coinbase', ['APICredential'])

        # Adding model 'SellOrder'
        db.create_table(u'coinbase_sellorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('api_credential', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coinbase.APICredential'])),
    ...
    def backwards(self, orm):
        # Deleting model 'APICredential'
        db.delete_table(u'coinbase_apicredential')
    ...
    models = {
        ...
        u'coinbase.apicredential': {
            'Meta': {'object_name': 'APICredential'},
        ...
        u'coinbase.currentbalance': {
            ...
            'api_credential': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['coinbase.APICredential']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
