...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SendBTC.destination_email'
        db.add_column(u'coinbase_sendbtc', 'destination_email',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'coinbase_sendbtc', 'destionation_email',
                      self.gf('django.db.models.fields.EmailField')(blank=True, max_length=75, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'SendBTC.destination_email'
        db.delete_column(u'coinbase_sendbtc', 'destination_email')
