...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MerchantDoc'
        db.create_table(u'profiles_merchantdoc', (
            ...
            ('img_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'profiles', ['MerchantDoc'])


    def backwards(self, orm):
        # Deleting model 'MerchantDoc'
        db.delete_table(u'profiles_merchantdoc')
    ...
    models = {
        ...
        u'profiles.merchantdoc': {
            'Meta': {'object_name': 'MerchantDoc'},
            'deleted_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
