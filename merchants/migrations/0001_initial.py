...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'merchants_merchant', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.AuthUser'], null=True, blank=True)),
            ('business_name', self.gf('django.db.models.fields.CharField')(max_length=256, db_index=True)),
            ('address_1', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=256, null=True, blank=True)),
            ...
            ('minimum_confirmations', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, null=True, db_index=True, blank=True)),
        ))
